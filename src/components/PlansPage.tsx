...
export default function PlansPage({
  ...
  // Clean generated PIX pay string
  const pixCode = generateStaticPix('raimundomoreira1988@gmail.com', pixAmount);
  // Generate QR code with Google Charts API which bypasses container frame restrictions securely
  const qrCodeUrl = `https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl=${encodeURIComponent(pixCode)}`;
      ...
      {paymentStep === 'pix_checkout' && (
        <div className="max-w-2xl bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 mx-auto shadow-sm space-y-6 animate-scaleUp">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pt-2">
            ...
            <div className="bg-slate-50 border border-gray-150 p-4 rounded-2xl flex flex-col items-center shrink-0 w-[190px] shadow-sm select-none">
            ...
            <div className="flex-1 space-y-4 w-full text-left">
              ...
              <div className="space-y-1">
                <span className="block text-[9px] font-bold text-gray-400 uppercase tracking-widest">Código Pix Copia e Cola</span>
